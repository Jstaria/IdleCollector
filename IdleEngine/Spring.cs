...
public class Spring
{
    ...
    private float deltaTime = 1 / 60.0f;
    ...
    public void Update()
    {
        CalcDampedSpringMotionParams(ref m_params, angularFrequency, dampingRatio);
    ...
    public void CalcDampedSpringMotionParams(
        ref tDampedSpringMotionParams pOutParams, float angularFrequency, float dampingRatio)
    {
